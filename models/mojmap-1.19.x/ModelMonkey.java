	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(10, 0)
						.addBox(-1.5386F, -0.5F, -2.1754F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(7, 7)
						.addBox(-1.5386F, -1.5F, -1.1754F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0386F, 13.75F, -3.3246F));

		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 10).addBox(0.0F, -8.75F, 2.0F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5386F, 7.5F, -2.1754F, 0.0F, -0.3927F, 0.0F));

		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(10, 3).addBox(2.0F, -8.75F, 3.0F, 1.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5386F, 7.5F, -2.1754F, 0.0F, 0.3927F, 0.0F));

		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create(),
				PartPose.offset(0.0F, 17.636F, 0.1213F));

		PartDefinition cube_r3 = Body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -7.0F, 5.0F, 3.0F, 8.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Tail = partdefinition.addOrReplaceChild("Tail", CubeListBuilder.create(),
				PartPose.offset(0.0F, 16.9858F, 5.9824F));

		PartDefinition cube_r4 = Tail.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(7, 18).addBox(1.0F, -6.75F, -2.25F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, 2.7642F, -2.7324F, -1.1345F, 0.0F, 0.0F));

		PartDefinition cube_r5 = Tail.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(5, 13).addBox(1.0F, -4.25F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition FrontLeftLeg = partdefinition.addOrReplaceChild("FrontLeftLeg", CubeListBuilder.create(),
				PartPose.offset(2.0F, 16.796F, -1.5417F));

		PartDefinition cube_r6 = FrontLeftLeg.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(17, 13).addBox(1.0F, -4.25F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = FrontLeftLeg.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(3, 18).addBox(1.0F, -8.0F, -1.0F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = FrontRightLeg.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 14).addBox(1.0F, -4.25F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, 7.204F, -2.4583F, -0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r9 = FrontRightLeg.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(16, 3).addBox(1.0F, -8.0F, -1.0F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, 7.204F, -2.4583F, -0.3927F, 0.0F, 0.0F));

		PartDefinition BackLeftLeg = partdefinition.addOrReplaceChild("BackLeftLeg", CubeListBuilder.create()
				.texOffs(11, 18).addBox(-0.5F, -0.3554F, -0.6496F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 18.6054F, 2.3996F));

		PartDefinition cube_r10 = BackLeftLeg.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(13, 13).addBox(1.0F, -4.25F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition BackRightLeg = partdefinition.addOrReplaceChild("BackRightLeg", CubeListBuilder.create()
				.texOffs(18, 0).addBox(-0.5F, -0.3554F, -0.6496F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 18.6054F, 2.3996F));

		PartDefinition cube_r11 = BackRightLeg.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(9, 13).addBox(1.0F, -4.25F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, 5.3946F, 1.6004F, 0.4363F, 0.0F, 0.0F));
